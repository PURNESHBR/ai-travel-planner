...
function CreateTrip() {
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10'>
      ...
      <p className='mt-3 text-gray-500 text-xl'>Just Provide The Basic Information And Our AI will Give U The Results Based On Your Information   </p>
      <div className='mt-20 flex flex-col gap-10'>
        ...
        <div>
        <h2 className='text-xl my-3 font-medium'>How Many Days Are You Planing Your Trip? </h2>
      ...
      <div className='my-10 justify-end text-center '>
        <Button 
        disabled={loading}
